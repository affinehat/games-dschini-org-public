...
class CallerServiceHelper
{
	...
	*/
	...
	/*
	 * This function will take NVPString and convert it to an Associative Array and it 
	 * will decode the response.
