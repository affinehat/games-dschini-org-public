package {
	...
	public class game extends MovieClip {
		...
		var targets:ExtendedArray = new ExtendedArray(
			...
			{title:'Colorado Springs, USA',x:175.25,y:312.8},
			...
			{title:'Vancouver, Canada',x:136.2,y:280.9},
			...
			{title:'Jerusalem, Israel',x:471.5,y:330.3},
			...
			{title:'Beijing, China',x:641.85,y:310.2},
			...
			{title:'Edinburgh, United Kingdom',x:390.75,y:257.2},
			...
			{title:'Bodo, Norway',x:428.4,y:206.15},
