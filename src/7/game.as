package {
	...
	public class game extends MovieClip {
		...
		public function init(event:Event):void
		{
			...
			data.urlSaveHighscore = 'http://games.dschini.org/play/7/savescore/';
		...
		var targets:ExtendedArray = new ExtendedArray(
					...
					//{title:'Hyderabad, India',x:563.75,y:365.05},
					...
					{title:'Washington, USA',x:233.6,y:309.7},
					...
					{title:'Washington, USA',x:234.2,y:312.3},
					...
					{title:'Mondeoza, Argentina',x:251.4,y:478.2},
					...
					{title:'Rio Grande, Brazil',x:286.6,y:472.4},
					...
					//{title:'Djakarta, Malaysia',x:623.75,y:414.75},
					...
					{title:'Djibouti, Somalia',x:488.2,y:376.3},
					{title:'Muqdisho, Somalia',x:492.3,y:396.45},
					...
					{title:'Bari, Italia',x:433.2,y:305.8},
					{title:'Napoli, Italia',x:427.15,y:306},
					{title:'Palermo, Italia',x:425.4,y:313.45},
					{title:'Malta, Republic of Malta',x:426.6,y:318.15},
					{title:'Milano, Italia',x:415.75,y:292.7},
					{title:'Genova, Italia',x:416.4,y:295.45},
					...
					{title:'Tbilisi, Gerogia',x:492.3,y:304.05},
					...
					{title:'Copenhagen, Denmak',x:422.9,y:259.6},
